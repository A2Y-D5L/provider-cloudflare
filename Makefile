...
PROJECT_REPO ?= github.com/a2yd5l/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 4.37.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= cloudflare
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-cloudflare_v4.37.0
